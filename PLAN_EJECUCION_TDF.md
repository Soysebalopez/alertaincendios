...
- **2026-05-30** — Workflow de investigación (7 agentes) → hallazgo bloqueador TdF + plan.
  ...
  - ⏭️ Próximo: **mergear PR #48** → verificación post-deploy (P0-3) → arrancar outreach P1-5. Pendiente además: P2 (dead-man's-switch healthchecks — necesita cuenta Healthchecks.io del owner; métrica dashboard; .env.example).
